...
var totalElec=document.getElementById('total_elec');
function datainter(){
    if(dataFlag){
        totalElec.innerText=""+data[0];
    }
}
setInterval(datainter,1000)
function dycharts(){
    var date1 = [];
    ...
    function addData(shift) {
        // for(var i=0;i<24;i++){
        //     var col=sheet[1][i+1].split(',');
        //     alert(col[0]);
        // };
        // now = [now.getFullYear(), now.getMonth() + 1, now.getDate()].join('/');
        var coltime=sheet[1][timecount].split(',')[0];
        // alert(coltime)
        date1.push(coltime);
        ...
        var col=parseInt(sheet[1][timecount].split(',')[1]);
        var col1=parseInt(sheet[1][timecount].split(',')[2]);
    ...
    var myChart = echarts.init(document.getElementById('dychart'));
...
$(function(){
    var myChart = echarts.init($("#nianfuhe")[0]);
    var option = {
        tooltip: {   //提示框，鼠标悬浮交互时的信息提示
            show: true,
            trigger: 'axis'
...
$(function(){
    var myChart = echarts.init($("#rifuhe")[0]);
    var option = {
        tooltip: {   //提示框，鼠标悬浮交互时的信息提示
            show: true,
            trigger: 'axis'
...
$(function(){
    var myChart = echarts.init($("#yuefuhe")[0]);
    var option = {
        tooltip: {   //提示框，鼠标悬浮交互时的信息提示
            show: true,
            trigger: 'axis'
...
// $(function(){
//     var myChart = echarts.init($("#pertotal")[0]);
//     option = {
//         tooltip : {
//             trigger: 'axis'
//         },
...
function AnQuan(){
    $(function(){
        var myChart = echarts.init($("#danweinenghao")[0]);
        option = {
            tooltip : {
                trigger: 'axis'
            },
    ...
    // 安全分析
    $(function(){
        var myChart = echarts.init($("#qingjienengyuan")[0]);
        option = {
            title : {
                text: '清洁能源组成',
                textStyle:{
...
// 事件级别分析
    ...
    $(function(){
        ...
        //     mycars[i]=col[0];
        // };
        var myChart = echarts.init($("#zhaomingnenghao")[0]);
        var option = {
            tooltip: {   //提示框，鼠标悬浮交互时的信息提示
                show: true,
                trigger: 'axis'
    ...
    $(function(){
        ...
        //     mycars[i]=col[0];
        // };
        var myChart = echarts.init($("#kongtiaonenghao")[0]);
        var option = {
            tooltip: {   //提示框，鼠标悬浮交互时的信息提示
                show: true,
                trigger: 'axis'
    ...
    $(function(){
        ...
        //     mycars[i]=col[0];
        // };
        var myChart = echarts.init($("#renjunkongtiaonenghao")[0]);
        var option = {
            tooltip: {   //提示框，鼠标悬浮交互时的信息提示
                show: true,
                trigger: 'axis'
